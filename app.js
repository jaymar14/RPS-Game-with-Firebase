  var config = {
    apiKey: "AIzaSyDvJPfW-DwZ7LWQpLw6slFf54-65v9jXsc",
    authDomain: "rps-game-f2bd7.firebaseapp.com",
    databaseURL: "https://rps-game-f2bd7.firebaseio.com",
    projectId: "rps-game-f2bd7",
    storageBucket: "rps-game-f2bd7.appspot.com",
    messagingSenderId: "448882784637"
  };
  firebase.initializeApp(config);

$(document).on('ready', function() {
	// Links to Firebase
	var database = new Firebase("https://rps-game-f2bd7.firebaseio.com/");
	var presenceRef = new Firebase("https://rps-game-f2bd7.firebaseio.com/.info/connected");
	var playersRef = new Firebase("https://rps-game-f2bd7.firebaseio.com/playersRef");
	var turnRef = new Firebase("https://rps-game-f2bd7.firebaseio.com/turn");
	var chatRef = new Firebase("https://rps-game-f2bd7.firebaseio.com/chat");
